      ...
      <aside className={`fixed md:static inset-y-0 left-0 z-40 w-72 bg-sidebar text-sidebar-foreground flex flex-col border-r border-sidebar-border transition-transform duration-300 ${open ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-md bg-foreground text-background flex items-center justify-center font-serif font-bold text-base">
              A
            </div>
            <div>
              <h2 className="font-serif font-semibold leading-none text-[16px] text-sidebar-foreground">Aura Chat</h2>
              <p className="text-[10px] uppercase tracking-[0.15em] text-sidebar-foreground/50 mt-1.5 font-medium">Educational AI</p>
            </div>
          </div>
        ...
        <div className="px-3 pb-3">
          <Button onClick={onNew} className="w-full bg-foreground hover:bg-foreground/90 text-background border-0 justify-start gap-2.5 h-10 rounded-md font-medium text-sm">
            <Plus className="h-4 w-4" /> New chat
          </Button>
        </div>

        <div className="flex-1 overflow-y-auto px-2 pb-2 space-y-0.5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-sidebar-foreground/50 px-3 py-2">Recent</p>
        ...
        <div className="p-3 border-t border-sidebar-border">
          <div className="flex items-center gap-2.5 px-2 py-2">
            <div className="h-8 w-8 rounded-md bg-foreground text-background flex items-center justify-center text-sm font-serif font-semibold flex-shrink-0">
